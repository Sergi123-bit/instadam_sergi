...
Element: Color primari
- Color clar: #1565C0 (blau fosc)
- Color fosc: #1565C0
- Motiu: Contrast alt sobre blanc i negre

Element: Fons Splash
- Color clar: #1565C0
- Color fosc: #1565C0
- Motiu: Identitat visual de l'app

Element: Like actiu
- Color clar: Colors.red + icona plena
- Color fosc: Colors.red + icona plena
- Motiu: Doble senyal: color + forma

Element: Feedback èxit
- Color clar: Colors.green[700] + 👍
- Color fosc: Colors.green[700] + 👍
- Motiu: Color + emoji, no depèn d'un sol codi

Element: Feedback error
- Color clar: Colors.red[700] + 👎
- Color fosc: Colors.red[700] + 👎
- Motiu: Color + emoji, no depèn d'un sol codi

Element: Camp bloquejat
- Color clar: Colors.grey[200]
- Color fosc: Colors.grey[800]
- Motiu: Indica visualment que no és editable

Element: Botó de logout
- Color clar: Colors.red + text blanc
- Color fosc: Colors.red + text blanc
- Motiu: Acció destructiva clarament diferenciada
